...
[task_local]
#京东手机狂欢城
12 12 * * * jd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "12 12 * * *" script-path=jd_carnivalcity.js, tag=京东手机狂欢城

====================Surge================
京东手机狂欢城 = type=cron,cronexp=12 12 * * *,wake-system=1,timeout=3600,script-path=jd_carnivalcity.js

============小火箭=========
5G狂欢城 = type=cron,script-path=jd_carnivalcity.js, cronexpr="12 12 * * *", timeout=3600, enable=true
*/
